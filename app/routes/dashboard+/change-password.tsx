    ...
    <div className="mx-auto max-w-4xl space-y-10">
      <section className="space-y-2">
        ...
        <p className="text-foreground/70">
          New password minimum 8 characters long, maximum 32 characters long, and cannot be the same
      ...
      <section className="space-y-2">
        ...
        <p className="text-foreground/70">
          If the user signed up using OAuth or another provider, they will not have a password or
          credentials for their account. It is recommended that the user go through the "forgot
          password" flow to set a password for their account.{" "}
          <a
